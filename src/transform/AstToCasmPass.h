...
#ifndef _LIBSCOD_AST_TO_CASM_PASS_H_
#define _LIBSCOD_AST_TO_CASM_PASS_H_
...
{
    /**
     * @brief Transforms AST to CASM representation
     */
    class AstToCasmPass final : public libpass::Pass
    {
      public:
        static char id;
...
#endif  // _LIBSCOD_AST_TO_CASM_PASS_H_
