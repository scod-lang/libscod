...
#ifndef _LIBSCOD_LEXER_H_
#define _LIBSCOD_LEXER_H_
...
namespace libscod
{
    ...
    class Lexer : public libscod_FlexLexer
    {
      public:
        ...
        CST::Spans::Ptr fetchSpansAndReset( void );
      ...
      private:
        ...
        std::string m_strbuf;
        CST::Spans::Ptr m_spans;
    };
}

#endif  // _LIBSCOD_LEXER_H_
