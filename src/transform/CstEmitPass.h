...
#ifndef _LIBSCOD_CST_EMIT_PASS_H_
#define _LIBSCOD_CST_EMIT_PASS_H_
...
{
    /**
       @brief Translates the CST to SCOD source code and dumps it
     */
...
#endif  // _LIBSCOD_CST_EMIT_PASS_H_
