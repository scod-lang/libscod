...
SkipStatement::SkipStatement( void )
...
BlockStatement::BlockStatement( const Statements::Ptr& statements )
...
const VariableBinding::Ptr& LetStatement::variableBinding( void ) const
{
