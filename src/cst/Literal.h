...
#ifndef _LIBSCOD_CST_LITERAL_H_
#define _LIBSCOD_CST_LITERAL_H_
    ...
    namespace CST
    {
        ...
        class ReferenceLiteral final : public Literal
        {
          public:
            ...
            ReferenceLiteral( const Token::Ptr& atToken, const IdentifierPath::Ptr& target );

            const Token::Ptr& atToken( void ) const;
