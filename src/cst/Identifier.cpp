...
, m_name( name )
, m_namespaceToken( Token::unresolved() )
...
void Identifier::setNamespaceToken( const Token::Ptr& namespaceToken )
{
    m_namespaceToken = namespaceToken;
}

const Token::Ptr& Identifier::namespaceToken( void ) const
{
