...
#ifndef _LIBSCOD_CST_IDENTIFIER_H_
#define _LIBSCOD_CST_IDENTIFIER_H_
    ...
    namespace CST
    {
        class Identifier final : public Node
        {
          public:
            ...
            void setNamespaceToken( const Token::Ptr& namespaceToken );
            const Token::Ptr& namespaceToken( void ) const;
...
#endif  // _LIBSCOD_CST_IDENTIFIER_H_
