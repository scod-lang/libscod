...
void libscod_main_dummy( void )
{
    const auto source =
        libstdhl::Memory::make< libstdhl::Log::Source >( "libscod", "SCOD Library" );

    libstdhl::Log::defaultSource( source );
}

TEST( libscod_main, empty )
{
    std::cout << libscod::REVTAG << "\n";
    std::cout << libscod::COMMIT << "\n";
    std::cout << libscod::BRANCH << "\n";
    std::cout << libscod::LICENSE << "\n";
    std::cout << libscod::NOTICE << "\n";
}
