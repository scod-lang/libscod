...
#ifndef _LIBSCOD_AST_STATEMENT_H_
#define _LIBSCOD_AST_STATEMENT_H_
    ...
    namespace AST
    {
        ...
        class BlockStatement final : public Statement
        {
          public:
            ...
            explicit BlockStatement( const Statements::Ptr& statements );
        ...
        class LetStatement final : public Statement
        {
          public:
            ...
            explicit LetStatement(
                const VariableBinding::Ptr& variableBinding, const Statement::Ptr& statement );

            const VariableBinding::Ptr& variableBinding( void ) const;
          ...
          private:
            const VariableBinding::Ptr m_variableBinding;
        ...
        class AssignmentStatement final : public Statement
        {
          public:
            ...
            explicit AssignmentStatement(
                const DirectCallExpression::Ptr& target, const Expression::Ptr& expression );
...
#endif  // _LIBSCOD_AST_STATEMENT_H_
